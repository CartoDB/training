...
* Log into your `geostatXX` account going to `https://geostatXX.carto.com`

----

## Introduction to CARTO <a name="intro"></a>

Slides available [here](https://docs.google.com/presentation/d/1hZ1ddeS2UdShQNVSYb6tRl4IdQTya496xRA2N2wqygI/pub?start=false&loop=false&delayms=3000)

![](../img/160921-geostat/slides.png)
...
* [Load a visualisation with `createVis()`](http://plnkr.co/edit/plhwv3IQwFxLHBGWodQp?p=preview)
* [Load SQL+CartoCSS anonymous map with `createLayer`](http://plnkr.co/edit/aG7ZSN24WBE6d8ZJQTqY?p=preview)
* [Load named map with `createLayer`](http://plnkr.co/edit/HitBoz?p=preview)

Changing the visualization:

* [Change SQL and CartoCSS dynamically](http://plnkr.co/edit/SzMbyj?p=preview)
* [Change named maps parameters](http://plnkr.co/edit/c7gFkI?p=preview)


Layer interactivity:

* [Events. Actions on feature click](http://plnkr.co/edit/88Qc99jdgP4X43FSTRdH?p=preview)
* [Custom Infowindows](http://plnkr.co/edit/9FE6BHILGudsIrDmCzdd?p=preview)
* [Custom Tooltip:](http://plnkr.co/edit/uD0Fdw?p=preview)

Advanced examples:

* [Highlight polygons on hover](http://bl.ocks.org/javisantana/8313604)
