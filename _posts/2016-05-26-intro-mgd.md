...
----
> Practice! Download and import the following datasets
----
...
Search, connect and disable their syncronization of the following datasets:
...
```sql
SELECT
  count(*) as total_rows --others aggregated functions: sum(), avg()...
FROM 
  ne_10m_populated_places_simple
```
